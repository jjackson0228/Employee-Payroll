...
const getRandomEmployee = function (employeesArray) {
  ...
  const randomIndex = Math.floor(Math.random() * employeesArray.length); //set const for randomIndex for a math function for random with all employees array 
  let randomEmployee = employeesArray[randomIndex]; //set randomEmployee set to that random index

  console.log(`Congrats to ${randomEmployee.firstName} ${randomEmployee.lastName}, our random drawing winner!`);
} //logged string to random employee first and last name 
